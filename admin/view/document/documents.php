        ...
        <table class="table table-bordered table-striped">
            <thead>
                <tr>
                    ...
                    <th>
                        <a href="index.php?pg=users&sort=document_name&order=ASC" class="sort-link">
                            Tên tài liệu
                            <i class="fas fa-sort"></i>
                        </a>
                    </th>
                    <th>
                        <a href="index.php?pg=users&sort=link&order=ASC" class="sort-link">
                            Link
                            <i class="fas fa-sort"></i>
                        </a>
                    </th>
                    <th>
                        <a href="index.php?pg=users&sort=display_order&order=ASC" class="sort-link">
                            Thứ tự hiển thị
                            <i class="fas fa-sort"></i>
                        </a>
                    </th>
                    <th>
                        <a href="index.php?pg=users&sort=field_name&order=ASC" class="sort-link">
                            Danh mục
                            <i class="fas fa-sort"></i>
                        </a>
                    </th>
            ...
            <tbody>
                <tr>
                    <td>1</td>
                    <td>Tài liệu A</td>
                    <td><a href="https://example.com/doc1">Link tài liệu A</a></td>
                    <td>1</td>
                    <td>Trường 1</td>
                    <td>
                ...
                <tr>
                    <td>2</td>
                    <td>Tài liệu B</td>
                    <td><a href="https://example.com/doc2">Link tài liệu B</a></td>
                    <td>2</td>
                    <td>Trường 2</td>
                    <td>
                        <a href="index.php?pg=updateuser&id=3">
                ...
                <tr>
                    <td>3</td>
                    <td>Tài liệu C</td>
                    <td><a href="https://example.com/doc3">Link tài liệu C</a></td>
                    <td>3</td>
                    <td>Trường 3</td>
                    <td>
                        <a href="index.php?pg=updateuser&id=3">
